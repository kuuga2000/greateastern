                    ...
                    <div class="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/dashboard" class="<?php echo isset($this->dashboard) ? $this->dashboard : '';?>"><i class="gi gi-stopwatch sidebar-nav-icon"></i>Dashboard</a>
                                </li>
                                 
                                <li>
                                    <a href="#" class="sidebar-nav-menu <?php echo isset($this->products_management) ? $this->products_management.' open active' : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>Product Management</a>
                                    <ul style="<?php echo isset($this->products_management) ? "display: block":'';?>;">
                                    	<li>
                                    		<a <?php echo isset($this->products) ? 'style="text-decoration:underline;"':'';?> href="<?php echo $this->baseUrl();?>/products/admin">Products</a>
                                    	</li>
                                    	<?php /*
                                    	<li>
                                    	...
                                    	<li>
                                    		<a <?php echo isset($this->status) ? 'style="text-decoration:underline;"':'';?> href="<?php echo $this->baseUrl();?>/status/admin">Status</a>
                                    	</li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/agents/admin" class="sidebar-nav-menu-x <?php echo isset($this->agents) ? $this->agents : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>Agents</a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/contacts/admin" class="sidebar-nav-menu-x <?php echo isset($this->contacts) ? $this->contacts : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>Contacts</a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/leads/admin" class="sidebar-nav-menu-x <?php echo isset($this->leads) ? $this->leads : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>Leads</a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/clients/admin" class="sidebar-nav-menu-x <?php echo isset($this->clients) ? $this->clients : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>Clients</a>
                                </li>
                                <li>
                                    <a href="<?php echo $this->baseUrl();?>/config" class="sidebar-nav-menu-x <?php echo isset($this->config) ? $this->config : '';?>"><i class="gi gi-charts sidebar-nav-icon"></i>General Configuration</a>
                                    <!--<ul>
                                    	<li>
