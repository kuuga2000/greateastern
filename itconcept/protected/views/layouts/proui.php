...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/favicon.ico">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon57.png" sizes="57x57">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon72.png" sizes="72x72">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon76.png" sizes="76x76">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon114.png" sizes="114x114">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon120.png" sizes="120x120">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon144.png" sizes="144x144">
        <link rel="apple-touch-icon" href="<?php echo $this->baseUrl();?>/themes/proui/img/icon152.png" sizes="152x152">
        <!-- END Icons -->

        <!-- Stylesheets -->
        <!-- Bootstrap is included in its original form, unaltered -->
        <link rel="stylesheet" href="<?php echo $this->baseUrl();?>/themes/proui/css/bootstrap.min.css">

        <!-- Related styles of various icon packs and plugins -->
        <link rel="stylesheet" href="<?php echo $this->baseUrl();?>/themes/proui/css/plugins.css">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="<?php echo $this->baseUrl();?>/themes/proui/css/main.css">

        <!-- Include a specific file here from css/themes/ folder to alter the default theme of the template -->

        <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
        <link rel="stylesheet" href="<?php echo $this->baseUrl();?>/themes/proui/css/themes.css">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) & Respond.js (Enable responsive CSS code on browsers that don't support it, eg IE8) -->
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/vendor/modernizr-2.7.1-respond-1.4.2.min.js"></script>
    </head>
    <body>
        <!-- Page Wrapper -->
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="chat-users clearfix">
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar12.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar15.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar10.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-online">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar4.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-away">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar7.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-away">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar9.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="chat-user-busy">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar16.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar1.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar3.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar13.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <span></span>
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle">
                                    </a>
                                </li>
                            </ul>
                            <!-- END Chat Users -->
                            ...
                            <div class="chat-talk display-none">
                                ...
                                <div class="chat-talk-info sidebar-section">
                                    ...
                                    <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar5.jpg" alt="avatar" class="img-circle pull-left">
                    ...
                    <div class="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-section sidebar-user clearfix">
                                <div class="sidebar-user-avatar">
                                    <a href="page_ready_user_profile.html">
                                        <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar2.jpg" alt="avatar">
                                    </a>
                                </div>
                            ...
                            <ul class="sidebar-section sidebar-themes clearfix">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-night themed-border-night" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/night.css" data-toggle="tooltip" title="Night"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-amethyst themed-border-amethyst" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/amethyst.css" data-toggle="tooltip" title="Amethyst"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-modern themed-border-modern" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/modern.css" data-toggle="tooltip" title="Modern"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-autumn themed-border-autumn" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/autumn.css" data-toggle="tooltip" title="Autumn"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-flatie themed-border-flatie" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/flatie.css" data-toggle="tooltip" title="Flatie"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-spring themed-border-spring" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/spring.css" data-toggle="tooltip" title="Spring"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-fancy themed-border-fancy" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/fancy.css" data-toggle="tooltip" title="Fancy"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="themed-background-dark-fire themed-border-fire" data-theme="<?php echo $this->baseUrl();?>/themes/proui/css/themes/fire.css" data-toggle="tooltip" title="Fire"></a>
                                </li>
                            </ul>
                            <!-- END Theme Colors -->
                ...
                <div id="main-container">
                    ...
                    <header class="navbar navbar-default">
                        ...
                        <ul class="nav navbar-nav-custom pull-right">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
                                </a>
                                            ...
                                            <ul class="timeline-list">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo1.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo22.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                                                    <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo23.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-advanced widget-advanced-alt">
                                        ...
                                        <div class="widget-header text-left">
                                            ...
                                            <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
                                            ...
                                            <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
                                                <div class="row">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo15.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo15.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo5.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo5.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo6.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo6.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-3">
                                                        <a href="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo13.jpg" class="gallery-link" title="Image Info">
                                                            <img src="<?php echo $this->baseUrl();?>/themes/proui/img/placeholders/photos/photo13.jpg" alt="image">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/jquery.min.js"></script>
        <script>!window.jQuery && document.write(decodeURI('%3Cscript src="<?php echo $this->baseUrl();?>/themes/proui/js/vendor/jquery-1.11.1.min.js"%3E%3C/script%3E'));</script>

        <!-- Bootstrap.js, Jquery plugins and Custom JS code -->
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/vendor/bootstrap.min.js"></script>
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/plugins.js"></script>
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/app.js"></script>

        <!-- Google Maps API + Gmaps Plugin, must be loaded in the page you would like to use maps (Remove 'http:' if you have SSL) -->
        <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/helpers/gmaps.min.js"></script>

        <!-- Load and execute javascript code used only in this page -->
        <script src="<?php echo $this->baseUrl();?>/themes/proui/js/pages/index.js"></script>
