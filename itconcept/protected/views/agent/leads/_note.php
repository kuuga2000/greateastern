...
<div class="row">
    <div class="block">
        <div class="block-title">
            <h2><strong><?php echo $title;?></strong></h2> | <h2 style="float: right;">Receiver : <strong><?php echo $receiver->lead_name;?></strong></h2>
        </div>
        <div class="form">
            ...
            <div class="form-group">
                ...
                <?php echo $form->hiddenField($model,'to_lead_id',array('class'=>'form-control','value'=>$receiver->id)); ?>
            </div>
