        ...
        <div class="form">
            ...
            <div class="form-group">
            	<div class="col-md-4">
	                ...
	                <?php }else{ ?>
	                <?php echo $form->textField($model,'date',array('class'=>'form-control datepicker','placeholder'=>'DD/MM/YY','value'=>date('d/m/Y',strtotime($model->date)))); ?>
	                <?php } ?>
            	...
            	<div class="col-md-8">
	            	...
	            	<div class="col-md-4">
	            		<?php echo $form->dropDownList($model,'H',$model->HH,array('class'=>'form-control'));?>
	                </div>
	                <div class="col-md-4">
	                	<?php echo $form->dropDownList($model,'I',$model->II,array('class'=>'form-control'));?>
	                </div>
	                <div class="col-md-4">
		                <?php echo $form->dropDownList($model,'A',$model->AA,array('class'=>'form-control'));?>
	                </div>
