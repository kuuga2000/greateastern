...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-md-2">
			<?php echo $form->dropDownList($model,'agent_id',CHtml::listData(GEAgent::model()->findAll(array('order'=>'first_name ASC')),'id','full_name'),array('empty'=>'Agents','class'=>'form-control')); ?>
		</div>
		<div class="col-md-1">
