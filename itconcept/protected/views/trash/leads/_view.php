...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('lead_name')); ?>:</b>
	<?php echo CHtml::encode($data->lead_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('lead_email')); ?>:</b>
	<?php echo CHtml::encode($data->lead_email); ?>
	<br />
