...
$client_id = '297966536960-b7go20i6m9bei2ijcd93l7fla3thb6ml.apps.googleusercontent.com';
$client_secret = 'JZ_TCNWM0goa7_yHhqjpjIU3';
$redirect_uri = 'http://localhost/testonly/oauth.php';
$max_results = 25;
...
echo $url = 'https://www.google.com/m8/feeds/contacts/default/full?max-results='.$max_results.'&oauth_token='.$accesstoken;
